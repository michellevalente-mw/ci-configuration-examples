• [![MATLAB](https://github.com/michellevalente-mw/ci-configuration-examples/actions/workflows/
ci.yml/badge.svg)](https://github.com/michellevalente/ci-configuration-examples/actions/
workflows/ci.yml)
